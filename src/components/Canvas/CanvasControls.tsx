    ...
    >
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-600 py-2 min-w-[280px] max-w-none max-h-[calc(100vh-160px)] overflow-y-auto overflow-x-hidden overscroll-contain">
        {shapeTypes.map((shape) => (
          ...
          >
            <div className="size-8 rounded-md bg-gray-100 dark:bg-slate-700 flex items-center justify-center shrink-0">
              <span className="w-6 h-6 flex items-center justify-center text-lg">{shape.icon}</span>
            </div>
  ...
  return (
    <>
      ...
      {toolbarPosition === 'left' && (
        ...
        >
          <div 
            className="flex flex-col gap-2 rounded-2xl bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border border-gray-200/60 dark:border-slate-600/50 p-2 overflow-x-hidden overflow-visible w-[56px] overscroll-contain"
            style={{
          ...
          >
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="px-2 py-1 text-sm font-medium text-gray-600 dark:text-gray-400 rounded-md border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-center min-w-[3.5ch]">
                {zoomPercentage}%
              </div>
      ...
      {toolbarPosition === 'bottom' && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40">
          <div className="flex items-center gap-2 rounded-2xl bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border border-gray-200/60 dark:border-slate-600/50 px-3 py-2 shadow-lg">
            ...
            <div className="px-3 py-1 text-sm font-medium text-gray-700 dark:text-gray-300 min-w-[4rem] text-center">
              {zoomPercentage}%
            </div>
