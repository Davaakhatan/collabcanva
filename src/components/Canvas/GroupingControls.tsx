...
export const GroupingControls: React.FC<GroupingControlsProps> = ({
  ...
  return (
    <div className={`flex flex-col items-center gap-2 w-full ${className}`}>
      ...
      >
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.75}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M19 7H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2m14 0V5a2 2 0 00-2-2M5 7V5a2 2 0 012-2m0 0h6a2 2 0 012 2v2M7 7h10" />
        </svg>
      </TButton>
